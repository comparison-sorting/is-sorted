...
[![Tests](https://img.shields.io/github/actions/workflow/status/comparison-sorting/is-sorted/ci.yml?branch=main&event=push&label=tests)](https://github.com/comparison-sorting/is-sorted/actions/workflows/ci.yml?query=branch:main)
